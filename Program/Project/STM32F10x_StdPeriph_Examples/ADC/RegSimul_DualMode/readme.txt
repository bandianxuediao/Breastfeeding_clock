...
一旦渠道转换经常是由软件启动，channel14转换的ADC1和ADC2转换channel11是在同一时间。在32位转换结果，然后储存在ADC1数据寄存器
DMA把这个表中的数据将被储存ADC_DualConvertedValueTab。这些连续的转换，在转换channel17 ADC1和ADC2 channel12上。合并后的转换结果也以DMA传送到同一目标缓冲区。
