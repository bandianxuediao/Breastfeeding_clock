...
void LED_Init(void)
{
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_5;				 //LED0-->PB.5 端口配置
...
void LED_blink(void)
{
				GPIO_SetBits(GPIOB,GPIO_Pin_8); 						 //PC13 输出高 
			  delay_ms(100);
			  GPIO_ResetBits(GPIOB,GPIO_Pin_8); 						 //PC13 输出高 
			  delay_ms(100);
}
void LED_blink2(void)
{
				GPIO_ResetBits(GPIOB,GPIO_Pin_5); 						 //PC13 输出高 
			  delay_ms(100);
			  GPIO_SetBits(GPIOB,GPIO_Pin_5); 						 //PC13 输出高 
			  delay_ms(100);
}
