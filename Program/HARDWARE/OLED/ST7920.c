...
#define LCD_DATA_IN()  {GPIOA->CRL&=0X00000000;GPIOA->CRL|=0X88888888;GPIOA->BSRR|=0x00FF;}
...
//控制线***********************************************************
#define LCD_RS_1    PBout(5)=1
#define LCD_RS_0    PBout(5)=0
//读写
...
//    GPIOB->CRH &= 0X000F00FF;	//PB10 11 13 14 15 推挽输出 	  RRD
